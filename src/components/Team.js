        ...
        <div style={{marginTop: '8rem'}} className='bg-gray-200 flex flex-col items-center'>
            <div style={{height: '400px'}} className='bg-gray-50 w-screen max-w-screen-xl mx-auto my-10 flex'>
                <div className='w-1/2 h-full flex flex-col items-center justify-center'>
                    ...
                    <div className='font-mono text-xl p-1'>Ex-Unionpay Blockchain Developer</div>
                    <div className='font-mono text-xl p-1'>NYU Bachelor of Science in Math</div>
                </div>
            ...
            <div style={{height: '400px'}} className='bg-gray-50 w-screen max-w-screen-xl mx-auto my-10 flex'>
                ...
                <div className='w-1/2 h-full flex flex-col items-center justify-center'>
                    ...
                    <div className='font-mono text-xl p-1'>C++ Expert</div>
                    <div className='font-mono text-xl p-1'>IoT Expert</div>
            ...
            <div style={{height: '400px'}} className='bg-gray-50 w-screen max-w-screen-xl mx-auto my-10 flex'>
                <div className='w-1/2 h-full flex flex-col items-center justify-center'>
                    ...
                    <div className='font-mono text-xl p-1'>Philosopher</div>
